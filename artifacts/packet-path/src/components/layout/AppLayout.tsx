  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <motion.aside
        ...
        className="sidebar-gradient flex flex-col h-full shrink-0 relative z-10"
        style={{ boxShadow: "4px 0 24px rgba(0,0,0,0.15)" }}
      >
        {/* Logo */}
        <div className="flex items-center gap-3 px-4 h-16 border-b border-white/8">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-blue-400 to-violet-600 flex items-center justify-center shrink-0 shadow-lg">
          ...
          {collapsed ? (
              ...
              <TooltipTrigger asChild>
                <Link href="/cases/new">
                  <button
                    ...
                    className="w-10 h-10 rounded-xl bg-blue-500 hover:bg-blue-400 flex items-center justify-center transition-colors"
                  >
            ...
            <Link href="/cases/new">
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-blue-500 hover:bg-blue-400 text-white text-sm font-medium transition-colors"
              >
                <Plus size={15} />
                <span>New Case</span>
              </button>
        ...
        {/* PHI badge */}
        {!collapsed && (
          <div className="mx-3 mb-3 px-3 py-2 rounded-xl bg-emerald-900/30 border border-emerald-500/20">
